...
module.exports = class Peer {
    ...
    // Concert Mode: `options.appData` viaja al producer y `options.paused` lo crea en pausa
    // (el micrófono del público no suena hasta GO LIVE). Sin options se comporta como en B-Talk.
    async createProducer(producerTransportId, producer_rtpParameters, producer_kind, producer_type, options = {}) {
